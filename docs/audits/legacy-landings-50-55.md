...
least one role found a real historical parity or diagnostic issue. All six are now resolved on
current `main` by later fix commits or retro follow-ups, including the Batch 52 full-denominator
mass-factor matching fix.
