...
can also consume the retained phase-0 packet-set qualification verdict and one
diagnostic-review summary sidecar, audits the durable checklist/doc targets,
...
blockers, and typed-failure diagnostic-review blockers visible without claiming
that `Milestone M6` or `Milestone M7` has closed.
