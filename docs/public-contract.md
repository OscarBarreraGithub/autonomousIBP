...
- the actual SSH remote `main` state for this packet now runs through
  ...
  not-yet-accepted public/runtime seams described below through `Batch 64bo`, all of which stay
  ...
  the current worktree also carries the local-only narrow `Batch 64a` through `Batch 64bo`
...
- current worktree `Batch 61` continuation-plan slices now include the narrow `Batch 61aw`
  ...
  or exactly two, three, four, five, six, seven, or eight ordered upper-half-plane complex waypoints
  ...
  nine-plus-waypoint complex detours,
