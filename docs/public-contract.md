...
- current worktree `Batch 61` continuation-plan slices now include the narrow `Batch 61ak`
  ...
  or exactly two or three ordered upper-half-plane complex waypoints between real endpoints only
