...
diagnostic-review sidecar preservation, the packet-level and packet-set candidate failure-code
audits, and the single-packet plus packet-set retained-reference comparators and correct-digit
scorers without needing a full benchmark packet. `amflow-tests`
