...
| `user_defined_amfmode` | `examples/user_defined_amfmode/run.wl` | M5 lane50 scoped comparison, 6/6 coefficients, min 42 digits; current result is eta-infinity/asymptotic scoped and still defers eta=0 endpoint extraction. | `reproduced-partial` |
