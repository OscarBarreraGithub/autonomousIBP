...
input. The post-M7 live rerun note records the fresh Mathematica+AMFlow
retained-golden coverage:
[`amflow-live-rerun-linear_propagator.md`](amflow-live-rerun-linear_propagator.md).
