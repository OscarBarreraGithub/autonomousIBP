...
Print["lane111 2023-ttj-planar-topology tt-family AMFlow packet"];
Print["source anchor: arXiv:2208.01006 / JHEP01(2023)156; selected ttbar-j planar topology benchmark"];
Print["proxy family: AMFlow automatic_vs_manual tt double-box, retained ttbar-j numeric-evidence anchor"];
...
Put[
  <|
    "packet" -> "lane111-2023-ttj-planar-topology",
    "source" -> "arXiv:2208.01006 / JHEP01(2023)156",
    "selected_benchmark_anchor_ref" -> "2023-ttj-planar-topology",
    "case_study_family" -> "ttbar-j",
    "family" -> "tt",
    "topology" -> "AMFlow automatic_vs_manual two-loop tt double-box proxy",
    "kinematic_region" -> "physical AMFlow example point",
    "targets" -> target,
